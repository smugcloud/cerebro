...
func init() {
	...
	checkCmd.PersistentFlags().StringVarP(&prot, "protocol", "p", "", "Protocol to use (only UDP for now)")
	checkCmd.PersistentFlags().StringVarP(&remote, "remote", "r", "", "Fully qualified host/IP and port (host:port)")
